...
### Fixed
- Use `os.homedir()` instead of `process.env.HOME` for Windows compatibility
- Log directory and file now work correctly on Windows systems
...
- File-based logging to `~/.config/opencode/log/mad-plugin.log`
