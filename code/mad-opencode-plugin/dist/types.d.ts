 ...
 */
export declare function isSyncEventBody(data: unknown): data is SyncEventBody;
/**
 * Type guard for SyncMessageBody
 */
export declare function isSyncMessageBody(data: unknown): data is SyncMessageBody;
/**
 * Type guard for SyncToolBody
 */
export declare function isSyncToolBody(data: unknown): data is SyncToolBody;
